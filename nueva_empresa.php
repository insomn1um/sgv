...
// Solo administradores y supervisores pueden crear empresas
if (isOperador()) {
...
// Procesar formulario
if ($_POST && isset($_POST['crear_empresa'])) {
    ...
    if (empty($nombre) || empty($rut)) {
        ...
        // Obtener el user_id de la sesión, o usar null si no está disponible
        $user_id = $_SESSION['user_id'] ?? null;
        
        if ($empresa->crear($nombre, $rut, $razon_social, $direccion, $telefono, $email, $user_id)) {
            // Solo registrar auditoría si hay un usuario logueado
            if ($user_id) {
                registrarAuditoria('create', 'empresas', 'Empresa creada', [
                    'nombre' => $nombre,
                    'rut' => $rut,
            ...
            // Verificar si el error es por RUT duplicado
            if ($empresa->rutExiste($rut)) {
                $mensaje = 'Error: El RUT ' . htmlspecialchars($rut) . ' ya está registrado en el sistema.';
                $tipo_mensaje = 'danger';
            } else {
...
<head>
    ...
    <style>
        /* Estilos específicos para nueva_empresa.php si son necesarios */
    </style>
</head>
<body>
    <!-- Navbar -->
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted">Registrar una nueva empresa o contratista</p>
                        </div>
                        <a href="gestion_empresas.php" class="btn btn-outline-secondary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    ...
                                    <button type="submit" name="crear_empresa" class="btn btn-primary">
