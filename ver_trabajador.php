                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">
                                                <a href="ver_empresa.php?id=<?php echo $datos_trabajador['empresa_id']; ?>" class="text-decoration-none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">
                                                <?php 
                                                $condicion = $datos_trabajador['empresa_condicion'];
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="ver_empresa.php?id=<?php echo $datos_trabajador['empresa_id']; ?>" class="btn btn-outline-primary">
